 ...
 * @author Angel
 */
@WebServlet(name = "SnCconfirmaMedico", urlPatterns = {"/SnCconfirmaMedico"})
public class SnCconfirmaMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (val == 0) {
                ...
                out.println(DisplayError("Ya existe una cita reservada para ese dia!...", "/ClinicaNazareth/medico/indexmedico.jsp"));
            }
            rset.close();
            sta.close();
            cnn.close();
    ...
    private String DisplayEnvio() {
        //METODO QUE RETORNA UN ERROR CON FORMATO(BOOTSTRAP)
        String error = "<link href=\"scripts/bootstrap/css/bootstrap.css\" rel=\"stylesheet\"><style> #login{font-size:2em; width: 60%;margin:auto;margin-top:50px; }</style><div id='login' class='alert alert-success'>'La Cita esta creada esperadon confirmacion'<br><a href='/ClinicaNazareth/medico/indexmedico.jsp'>Regresar</a></div>";
        return error;
    }
