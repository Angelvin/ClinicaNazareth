...
<html>
    ...
    <body>
        <jsp:include page="menu.jsp"></jsp:include>
                            ...
                            <form method="GET" action="NuevaCita.jsp" id="myForm">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <%                                            if (cmbEspecialidad.getAttribute("sEspecialidad") == null || cmbEspecialidad.getAttribute("sEspecialidad").equals("")) {
                                                out.println(BAL.Assets.DisplayError("Primero seleccione una especialidad", "NuevaCita.jsp", "100", "1.2em"));
                                    ...
                                    <div class="form-group">
                                        ...
                                        <%
                                            if (cmbDoctor.getAttribute("sDoctor") == null || cmbDoctor.getAttribute("sDoctor").equals("")) {
                                                out.println(BAL.Assets.DisplayError("Seleccione un Dr valido", "NuevaCita.jsp", "100", "1.2em"));
                                                ...
                                                String query = "select (h.horaini) as HorasDisponibles, h.idhorario from  horario as h inner join empleado as e on e.idEmpleado=h.fkempleado where h.fkempleado=" + cmbDoctor.getAttribute("sDoctor") + " order by HorasDisponibles asc";
                                                ResultSet rs = null;
                                                try {
                                                    rs = pst.executeQuery(query);
                                                    out.println("<select class='form-control' id='idHorario' name='Horario' onchange='kk3();'");
                                                    out.println("<option></option>");
                                                    while (rs.next()) {
            ...
            function kk3() {
                document.getElementById('txthorario').value = document.getElementById("idHorario").value;
                            ...
                            <div class="col-md-4 well">
                                <form method="POST" action="../CrearCita">
                                    ...
                                    <fieldset>
                                        ...
                                        Horario: <input type="text" id="txthorario" name="thorario" class="form-control" value="<% out.println(request.getParameter("Horario"));%>" readonly>
