<%-- 
    ...
    Created on : 03-22-2014, 06:22:15 AM
    Author     : joss
--%>
...
<div id="divBoxed" class="container">
    ...
    <div class="divPanel notop nobottom">
	  ...
	  <label for="medicamento">Codigo medicamento</label>
        ...
        <select name="nombre" id="nombre">
            <option value="">Amoxicilina tableta</option>
            <option value="">Acetaminofen frasco</option>
            <option value="">Ibuprofeno</option>
            <option value="">Loratadina</option>
            <option value="">Multivitaminas frasco</option>
  ...
  <div>
        ...
        <input type="text" name="ingreso6" id="ingreso6"  placeholder="seleccione la fecha" /> 
        <img src="images/calendario.png" width="16" height="16" border="0" title="Fecha Inicial" id="lanzador6" > <script type="text/javascript"> 
            Calendar.setup({ 
             inputField     :    "ingreso6",    
             ifFormat     :     "%d-%m-%Y",     
                button     :    "lanzador6"    
    ...
    <label for="Tipo_tratamiento">Presentacion</label>
