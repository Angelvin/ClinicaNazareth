                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xs-6 col-md-4"><label >Cargo</label>
                                                <a>Los valores de medico y especialidad solo seran asignados a al Rol medico, caso Contrario 
                                                    no permitira la creacion de empleado
                                                </a>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-md-4"><label >Especialidad Medico</label>
