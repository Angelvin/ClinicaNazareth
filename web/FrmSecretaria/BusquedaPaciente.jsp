...
<div class="row">
  ...
  <div><table class="table table-condensed">
    ...
    <tr>
      ...
      <td>Gómez</td>
      <td>Álvarado</td>
      <td><button class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">Editar</button>
</td>
      <td><a href="../FrmSecretaria/cita_agenda.html" target="_blank" class="btn btn-primary" onClick="window.open(this.href, this.target, 'width=500,height=800'); return false;">Genererar cita</a></td>
    </tr>
    <tr>
      <td>2</td>
      <td>Lili</td>
