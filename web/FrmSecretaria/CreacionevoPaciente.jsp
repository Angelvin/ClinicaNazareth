                    ...
                    <div class="panel-body">
                        <form name="form1" method="post" action="../creapaciente">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6"><label>Fecha </label><input class="form-control" name="txtfecha" type="date" max="<%=f.getFechalo()%>" id="txtfecha" size="10" maxlength="10" required> <a>La fecha debe ser menor a la actual</a></div>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-md-2"><SELECT class="form-control"  name="txtmuni"id="comboMunicipio" SIZE=1> 
                                                <%
