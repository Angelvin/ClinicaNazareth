...
<div>
                           ...
                           <jsp:useBean id="entrega" scope="request" class="BAL.despacho" />
                            <c:set var="lista" scope="request" value="${entrega.listado}"/>
                            <display:table name="lista" export="true" class="its" id="fila" defaultsort="1">
                            <display:setProperty name="export.rtf.filename" value="example.rtf" />
                            <display:column class="hidden" headerClass="hidden" property="codigo" group="1" title="codigo" />
                            <display:column class="Paciente" property="paciente" title="Paciente" group="2" style="width:262px;"/>
                            <display:column class="Fecha" property="fecha" title="Fecha Factura" group="3" style="width:120px;" />
                            <display:column class="Medicamento" property="medicamento" title="Medicamento" style="width:200px;" />
                            <display:column class="cant" property="cantidad" title="Cantidad" style="width:50px;" />
                            <display:setProperty name="export.pdf" value="true" />
                            <display:column title="Entregar" group="1">
                            <form name="Despacho" method="request" action="../srvDespacho" >
                            <input class="hidden" id="txtcodigo" name="txtcodigo"  value="${fila.codigo}">
                            <button type="submit" class="btn btn-sm btn-default" >Despachar</button>
                        </form>
                            </display:column>
                            </display:table>
