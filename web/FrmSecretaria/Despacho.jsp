...
<div id="divBoxed" class="container">
 ...
 <li class="next"></li>
  ...
  <div class="panel-body">
    ...
    <tr>
      <td width="6%">Id</td>
      <td width="24%">Factura</td>
      <td width="22%">Nombre</td>
      <td width="17%">Medicamentos</td>
      </tr>
    <tr class="danger">
      <td>1</td>
      <td>00123</td>
      <td> Ángel</td>
      <td width="17%">  <button type="button" class="btn btn-default" data-dismiss="modal">Medicamentos a Entregar</button>
       </td>
      <td width="31%">  <button type="button" class="btn btn-default" data-dismiss="modal">Hecho</button> </td>
    </tr>
    <tr >
      <td>1</td>
      <td>00123</td>
      <td>José</td>
      <td>  <button type="button" class="btn btn-default" data-dismiss="modal">Medicamentos a Entregar</button> </td>
      <td>  <button type="button" class="btn btn-default" data-dismiss="modal">Hecho</button> </td>
    </tr>
    <tr class="danger">
      <td>1</td>
      <td>00133</td>
