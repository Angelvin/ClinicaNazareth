...
<html>
                        ...
                        <form name="form1" method="post" action="../creapaciente">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-md-4">
                                            <input class="form-control" id="txtusuario" placeholder="EJEMPLO@EJEMPLO.COM" onblur="correo(this);">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" ><label>Contraseña</label><input name="contra"  id="txtcontra" type="password" class="form-control" placeholder="Password" required></div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" ><label>Primer Nombre</label><input id="txtnombrep" class="form-control"  placeholder="nombre" onblur="validatePass(this);"></div>
                                        <div class="col-md-6"><label>Segundo Nombre</label><input id="txtnombres" class="form-control" placeholder="nombre"></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6"><label>Primer Apellido</label><input   id="txtapellido"     class="form-control"  placeholder="apellido" onblur="validatePass(this);"></div>
                                        <div class="col-md-6"><label>Segundo Apellido</label><input   id="txtapellidos"  class="form-control" placeholder="apellido" onblur="validatePass(this);"></div>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-md-4"><label >Tipo </label><SELECT name="txttipodocu"  SIZE=1 id="txttipodocu" > 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-md-4"><label >Tipo </label><SELECT  SIZE=1 id="txttipotele"  name="txttipotele" > 
 ...
 <input name="txtcasa" type="text" id="txtcasa" class="form-control" placeholder="Casa" onblur="validatePass(this);">
        <input  name="txtcalle"  id="txtcalle " class="form-control"  placeholder="Calle" onblur="validatePass(this);">
                                    <label >Municipio</label><SELECT name="txtmuni" id="txtmuni"  SIZE=1> 
                                        <OPTION VALUE="1">PERSONAL</OPTION>
                                        <OPTION VALUE="2">TRABAJO</OPTION>
                                    </SELECT>
                                    <label >Departamento</label><SELECT NAME="selCombo" SIZE=1> 
                                        <OPTION VALUE="1">PERSONAL</OPTION>
                                        <OPTION VALUE="2">TRABAJO</OPTION>
                                    </SELECT>
                                </div>
