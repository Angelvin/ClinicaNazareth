...
<html>
    ...
    <body>
        <div class="nav navbar-default">
            ...
            <a href="index.html" id="divTagLine"><span class="camera_full_width">Gestion de Administracion</span>!</a>
        </div>
        <div class="container">
            <br>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-12 col-md-8">
                                <h2 class="panel-title">Bienvenida: Lucia</h2></div>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-5">
                                        <form>
                                            <fieldset class="well">
                                                <legend><span class="badge">paso 1</span> Seleccione una especialidad:</legend>
                                                <div class=" col-xs-6">
