                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                ...
                                                <table>
                                                    ...
                                                    <display:table name="list" export="true" id="fila"  class="table table-condensed"  >
                                                        ...
                                                        <display:column title="Editar">
                                                            <input type="text" id="codigoCita" name="codigoCita" value="${fila.codigo}" >
                                                            <a class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg" onClick="kk(${fila.codigo})">
                                                                enviar
                                                            </a>
                                                        </display:column>
                                                    </display:table>
                                                ...
                                                <script type="text/javascript">
                                                                var lol = document.getElementById('codigoCita');
                                                                function kk(UUID) {
                                                                    alert('el codigo es: ' + UUID);
                                                ...
                                                <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <br>
                                                            El UID malefico }:) es :<input name="txtaccion" type="text" id="txtaccion" class="frm-control">
                                                            <br>
                                                        </div>
                                                    </div>
                                                </div>
