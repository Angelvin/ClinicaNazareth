<%-- 
    Document   : examen
    Created on : 03-22-2014, 06:17:35 AM
    Author     : joss
--%>
    ...
    <div class="divPanel notop nobottom">
      ...
      <div class="form-group">
       ...
       <label for="fechasolicitud">Fecha de solicitud</label>
        <input type="text" name="ingreso4" id="ingreso4"  placeholder="seleccione la fecha" /> 
        <img src="images/calendario.png" width="16" height="16" border="0" title="Fecha de solicitud" id="lanzador4" > <script type="text/javascript"> 
            Calendar.setup({ 
             inputField     :    "ingreso4",    
             ifFormat     :     "%d-%m-%Y",     
                button     :    "lanzador4"     
       ...
       <div class="form-group">
        <label for="fechadeaplicacion">Fecha de aplicación</label>
        <input type="text" name="ingreso5" id="ingreso5"  placeholder="seleccione la fecha" /> 
        <img src="images/calendario.png" width="16" height="16" border="0" title="Fecha de aplicacion" id="lanzador5" > <script type="text/javascript"> 
            Calendar.setup({ 
             inputField     :    "ingreso5",    
             ifFormat     :     "%d-%m-%Y",    
                button     :    "lanzador5"    
        ...
        <p>Tipo de examen:</p>
        <p>
          <select name="examen_tipo" id="tipodeexamen"  >
        ...
        <div>
            ...
            <textarea name="" id="" cols="30" rows="10" class="form-control" placeholder="agregue aqui sus obervaciones"></textarea>
        </div>
...
<p>&nbsp;</p>
        <p>
          ...
          <input type="submit" name="btm_modificar" id="btm_modificar" value="Modificar">
          <input type="submit" name="btm_eliminar" id="btm_eliminar" value="Eliminar">
        </p>
