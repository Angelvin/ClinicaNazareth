<%-- 
    ...
    Created on : 03-22-2014, 06:26:48 AM
    Author     : joss
--%>
...
<div id="divBoxed" class="container">
    ...
    <div class="divPanel notop nobottom">
      ...
      <div class="form-group">
        ...
        <label for="fecha_ini">Fecha de inicio de tratamiento</label>
        <input type="text" name="ingreso1" id="ingreso1"  placeholder="seleccione la fecha" /> 
        <img src="images/calendario.png" width="16" height="16" border="0" title="Fecha Inicial" id="lanzador1" > <script type="text/javascript"> 
            Calendar.setup({ 
        ...
        <div class="form-group">
        <label for="fecha_soli">Fecha de solicitud</label>
        <input type="text" name="ingreso2" id="ingreso2"  placeholder="seleccione la fecha" /> 
        <img src="images/calendario.png" width="16" height="16" border="0" title="Fecha Inicial" id="lanzador2" > <script type="text/javascript"> 
            Calendar.setup({ 
        ...
        <div>
            ...
            <textarea name="" id="" cols="30" rows="10" class="form-control" placeholder="Desea agregar alguna observacion?"></textarea>
        </div>

        

        <div class="form-group">
        <label for="fecha_soli">Fecha de finalizacion de  tratamiento</label>
        <input type="text" name="ingreso3" id="ingreso3"  placeholder="seleccione la fecha" /> 
        <img src="images/calendario.png" width="16" height="16" border="0" title="Fecha Inicial" id="lanzador3" > <script type="text/javascript"> 
            Calendar.setup({ 
          ...
          <input type="submit" name="btm_guardar" id="btm_guardar" value="Guardar">
