<%-- 
    Document   : registro
    Created on : 03-22-2014, 04:46:01 AM
    Author     : joss
--%>
...
<div id="divBoxed" class="container">
            ...
            <div class="span12">
              ...
              <div id="divHeaderText" class="page-content">
                    <div id="divHeaderLine1">
                      <p class="camera_full_width"> Ingrese sus Datos                 </p>
                    </div>
                    <div >
  ...
  <tr>
    <td>Primer nombre</td>
    <td>
          <input type="text" name="id_noprim" id="id_noprim"></td>
  </tr>
  <tr>
    <td>segundo nombre</td>
    <td> <input type="text" name="segun_nombre" id="segun_nombre">
</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Direccion</td>
    <td><textarea name="direc" id="direc"></textarea></td>
  </tr>
  <tr>
    <td>Fecha nacimento</td>
    <td><select name="dia" id="dia"  >
               <option>dia/mes/año</option>
             </select></td>
  </tr>
  <tr>
    <td>Tipo documento </td>
    <td><select name="tEmple" id="tEmple">
                      <option>seleccione</option>
                      <option>Licencia</option>
                      <option>DUI</option>
                      <option>Pasaporte</option>
                      <option>Carnet minoridad</option>
                    </select></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>
      <input type="submit" name="guardar" id="guardar"  class="btn" value="Enviar">    </td>
    <td><input type="submit" name="guardar2" id="guardar2"  class="btn" value="Limpiar"></td>
  </tr>
</table>
